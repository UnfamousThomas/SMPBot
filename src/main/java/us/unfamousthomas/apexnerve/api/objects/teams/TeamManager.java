...
public class TeamManager {
    ...
    public void load() {
        List<TeamObject> teamsLoaded = mongoManager.getTeamDAO().find().asList();
        ...
        List<InviteObject> invitesLoaded = mongoManager.getInviteDAO().find().asList();
    ...
    public void createChannels(TeamObject team, Guild guild, Member leader) {
        ...
        //todo category work for multi-guild setup.
        ...
        user.setTeam(team);
        mongoManager.getUserDAO().save(user);
    }
    ...
    public void inviteToTeam(TeamObject team, Member member) {
        ...
        member.getGuild().getTextChannelById(team.getTeamChatChannelId()).sendMessage(Text.INVITED_TO_TEAM.getReplaced("%username",member.getUser().getName())).queue();
    }
    ...
    public void joinTeam(Member joining, TeamObject joinedTeam, InviteObject inviteObject) {
        joining.getGuild().getTextChannelById(joinedTeam.getTeamChatChannelId()).sendMessage(Text.JOINED_TEAM.getReplaced("%username", joining.getUser().getName())).queue();
    ...
    public void leaveTeam(Member leaving, TeamObject leftTeam) {
        leaving.getGuild().getTextChannelById(leftTeam.getTeamChatChannelId()).sendMessage(Text.LEFT_TEAM.getReplaced("%username", leaving.getUser().getName())).queue();
    ...
    public void kickTeam(Member leaving, TeamObject leftTeam) {
        leaving.getGuild().getTextChannelById(leftTeam.getTeamChatChannelId()).sendMessage(Text.KICKED_TEAM.getReplaced("%username", leaving.getUser().getName())).queue();
        ...
        leaving.getUser().openPrivateChannel().queue(privateChannel -> {
            privateChannel.sendMessage(Text.KICKED_FROM.getReplaced("%teamname", leftTeam.getName())).queue();
        });
    ...
    public void renameTeam(String newName, TeamObject team, Member leader) {
        ...
        mongoManager.getTeamDAO().save(team);
        addTeam(team, leader.getGuild());
        guild.getTextChannelById(team.getTeamChatChannelId()).sendMessage(Text.TEAM_RENAME.getReplaced("%newname", newName)).queue();
    ...
    public void setNewLeader(Member currentLeader, Member newLeader, TeamObject team) {
        ...
        newLeader.getGuild().getTextChannelById(team.getTeamChatChannelId()).sendMessage(Text.TEAM_NEW_LEADER.getReplaced("%newleader%", newLeader.getUser().getName())).queue();
    ...
    public void recolorTeam(Color color, TeamObject teamObject, Member leader) {
        ...
        guild.getTextChannelById(teamObject.getTeamChatChannelId()).sendMessage(Text.TEAM_COLOR_CHANGED.getMessage()).queue();
    }
